...
export const QuizReview = withText(translates)(({score, onRetake, onClose, reviewDetails, ...translates}: QuizReviewProps & QuizTranslates) => {
    ...
    <IvqOverlay>
      <div className={styles.quizReviewWrapper}>
        ...
        <div className={styles.buttonWrapper}>
          ...
          <button onClick={onClose} className={onRetake ? styles.secondaryButton : styles.primaryButton} aria-label={translates.doneButtonAreaLabel}>
